"""
Markdown Report Generator for DKSec.
...
class MarkdownReporter:
    ...
    def generate(report: DKSecReport, output_path: str) -> str:
        ...
        md = []
        md.append(f"# 🛡️ DKSec Product Security Audit Report: {report.project_name}")
        ...
        md.append("---")
        md.append("*DKSec Product Security Engine — Integrating Threat Dragon, ASVS, Semgrep, Trivy, Gitleaks, ZAP, WSTG, Nuclei, Amass, DefectDojo, OpenSSF Scorecard, and Wazuh.*")
